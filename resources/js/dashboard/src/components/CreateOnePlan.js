        ...
        <div className="w-full md:w-1/2 mx-auto">
            <form onSubmit={handleSubmit} className="flrx flex-col space-y-4">
                <div className="form-group">
                    <h5 className="text-center font-bold text-lg uppercase">
                        {props.plan.title}
                    </h5>
                </div>
                <div className="w-full">
                    ...
                    <input
                        ...
                        placeholder="Enter title eg MTN Airtime"
                    />
                </div>
                {/* <div className="w-full">
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateOnePlan);
