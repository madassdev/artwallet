                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle wide-xs mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            <h1 class="nk-error2-head">ARTWALLET</h1>
                            <h3 class="nk-error-title">Automated Solutions for Businesses</h3>
                            ...
                            <a href="{{route('login')}}" class="btn btn-lg btn-primary mt-2">Login to Dashboard</a>
                        </div>
                    </div><!-- .nk-block -->
                </div>
                <!-- wrap @e -->
