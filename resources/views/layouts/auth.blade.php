...
<head>
    ...
    <!-- Fav Icon  -->
    <link re_logol="shortcut icon" href="./images/artwallet_logo.png?chunk=1">
    <!-- Page Title  -->
    @yield('title')
    <!-- StyleSheets  -->
                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="https://artwallet.com.ng" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg" src="./images/artwallet_logo.png?chunk=1" srcset="./images/artwallet_logo.png?chunk=1 2x" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg" src="./images/artwallet_logo.png?chunk=1" srcset="./images/artwallet_logo.png?chunk=1 2x" alt="logo-dark">
                            </a>
                        </div>
                        @yield('content')
